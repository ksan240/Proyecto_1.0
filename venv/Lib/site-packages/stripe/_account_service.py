...
class AccountService(StripeService):
    ...
    class CreateParamsCompany(TypedDict):
        ...
        ownership_declaration: NotRequired[
            "AccountService.CreateParamsCompañownershipDeclaration"
        ]
        """
    ...
    class CreateParamsCompañownershipDeclaration(TypedDict):
        date: NotRequired[int]
        """
    ...
    class UpdateParamsCompany(TypedDict):
        ...
        """
        ownership_declaration: NotRequired[
            "AccountService.UpdateParamsCompañownershipDeclaration"
        ]
        """
        This hash is used to attest that the beneficial owner information provided to Stripe is both current and correct.
        """
    ...
    class UpdateParamsCompañownershipDeclaration(TypedDict):
        date: NotRequired[int]
        """
        The Unix timestamp marking when the beneficial owner attestation was made.
        """
